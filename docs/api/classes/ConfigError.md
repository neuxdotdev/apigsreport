[ApIgsReport Library](../globals.md) / ConfigError

# Class: ConfigError

Defined in: [handler/error.ts:129](https://github.com/neuxdotdev/apigsreport/blob/master/lib/handler/error.ts#L129)
...
Defined in: [handler/error.ts:136](https://github.com/neuxdotdev/apigsreport/blob/master/lib/handler/error.ts#L136)
